...
if [[ "$OSTYPE" == "darwin"* ]]; then
    PARAMS_DIR="$HOME/Library/Application Support/CruZetaParams"
else
    PARAMS_DIR="$HOME/.cruzeta-params"
fi
...
Failed to fetch the CruZeta zkSNARK parameters!
...
function main() {
    ...
    cat <<EOF
CruZeta - fetch-params.sh

This script will fetch the CruZeta zkSNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common CruZeta zkSNARK parameters. Note that it is
