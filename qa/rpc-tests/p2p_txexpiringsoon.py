...
class TxExpiringSoonTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Verify mininodes are connected to cruzetad nodes
        ...
        # Mininodes send expiring soon transaction in "tx" message to cruzetad node
        ...
        # Mininodes send transaction in "tx" message to cruzetad node
        ...
        # Send p2p message "mempool" to receive contents from cruzetad node in "inv" message
        with mininode_lock:
        ...
        # Mininodes send tx3 to cruzetad node
