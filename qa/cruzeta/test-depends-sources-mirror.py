...
# This script tests that the package mirror at https://cruzeta.org/depends-sources/
# contains all of the packages required to build this version of CruZeta.
#
# This script assumes you've just built CruZeta, and that as a result of that
...
MIRROR_URL_DIR="https://cruzeta.org/depends-sources/"
