...
LITECOINZ_CLI = './src/cruzeta-cli'
USAGE = """
Requirements:
- find
- xz
- %s (edit LITECOINZ_CLI in this script to alter the path)
- A running mainnet cruzetad using the default datadir with -txindex=1
...
LD_LIBRARY_PATH=src/leveldb python qa/cruzeta/create_benchmark_archive.py
""" % LITECOINZ_CLI
