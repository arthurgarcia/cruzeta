# Support for Output Descriptors in CruZeta Core

Since CruZeta Core v2.17, there is support for Output Descriptors in the
...
on CruZeta's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing CruZeta Core wallets, a convenience function `combo` is
