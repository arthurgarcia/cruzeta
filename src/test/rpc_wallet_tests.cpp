...
BOOST_AUTO_TEST_CASE(rpc_wallet_z_importwallet)
{
    ...
    std::string format_str = "# Wallet dump created by CruZeta v0.11.2.0.z8-9155cc6-dirty (2016-08-11 11:37:00 -0700)\n"
...
BOOST_AUTO_TEST_CASE(rpc_z_mergetoaddress_parameters)
{
    ...
    CheckRPCThrows("z_mergetoaddress 1 2",
        "Error: z_mergetoaddress is disabled. Run './cruzeta-cli help z_mergetoaddress' for instructions on how to enable this feature.");
