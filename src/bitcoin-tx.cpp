...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cruzeta-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cruzeta-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cruzeta transaction") + "\n" +
              "  cruzeta-tx [options] -create [commands]   " + _("Create hex-encoded cruzeta transaction") + "\n" +
              "\n";
