...
void BitcoinGUI::createActions()
{
    ...
    addressBookAction->setStatusTip(tr("View and manage the CruZeta address book"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CruZeta address using transparent transactions"));
    ...
    sendZCoinsAction->setStatusTip(tr("Send coins to a CruZeta address using private transacions"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cruzeta: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CruZeta addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->MultiColorIcon(":/images/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CruZeta addresses"));
    ...
    openAction->setStatusTip(tr("Open a cruzeta: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->MultiColorIcon(":/images/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible CruZeta command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CruZeta network", "", count));
}
...
{
    QString strTitle = tr("CruZeta"); // default title
