...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        ...
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  cruzeta-cli [options] <command> [params]  " + _("Send command to CruZeta") + "\n" +
                  "  cruzeta-cli [options] <command> [params]  " + strprintf(_("Send command to %s"), _(PACKAGE_NAME)) + "\n" +
                  "  cruzeta-cli [options] help                " + _("List commands") + "\n" +
                  "  cruzeta-cli [options] help <command>      " + _("Get help for a command") + "\n";
